...
<html>
<head>
	<link href="${basePath}css/user/css.css" rel="stylesheet" type="text/css" />
...
<body>
	<!-- 头部{ -->
	<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0" background="${basePath}images/user/xingzheng.png" class="top">
		<tr>
			<td width="26" height="106">&nbsp;</td>
			<td width="416" height="110" align="left" valign="middle">
				<img class="zxx_test_png" src="${basePath}images/home/ind01.png" width="470" height="100" alt="" />
			</td>
			<td width="135">&nbsp;</td>
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
                        ...
                        <td align="center"><img src="${basePath}images/user/help.png" width="12"height="17" /></td>
						<td align="left"><a href="javascript:void(0)">帮助</a></td>
						<td width="17" align="center"><img src="${basePath}images/user/exit.png"width="14" height="14"/></td>
