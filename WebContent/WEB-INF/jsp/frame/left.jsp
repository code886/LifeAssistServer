...
<head>
    <base href="<%=basePath%>"/>
    <link href="${ctx}/css/user/css.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/css/user/style.css" rel="stylesheet" type="text/css"/>
...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
                <dl class="">
                    <dt><a class="yh" href="${ctx }user/user_listUI.action" target="mainFrame"><b></b>用户管理<s class="down"></s>
                    </a></dt>
                </dl>

                <dl>
                    <dt><a class="xxfb" href="#" target="mainFrame" target="mainFrame"><b></b>天气数据<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="tssl" href="#" target="mainFrame"><b></b>定位数据<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="nszx" href="#" target="mainFrame"><b></b>推荐数据<s class="down"></s> </a></dt>
                </dl>

                <dl class="">
                    <dt><a class="fwdc" href="#" target="mainFrame"><b></b>服务管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="ygz" href="#" target="mainFrame"><b></b>通知管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
